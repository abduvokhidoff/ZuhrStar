...
const Oquvchilar = () => {
  ...
  const handleCreate = async () => {
    ...
    if (
      ...
      setUpdateMessage({
        text:
          "Iltimos, barcha majburiy maydonlarni to'ldiring (Ism, Familiya, Telefon raqami, Tug'ilgan sana, Jins, Parol)",
        type: 'error',
      });
      return;
    }
  ...
  const handleExportExcel = () => {
    try {
      const dataToExport = filteredStudents.map((student, index) => ({
        ...
        Holati: (student.status || '').toLowerCase() === 'active' ? 'Faol' : 'Nofaol',
            ...
            <div className="bg-white p-6 rounded-xl shadow-xl w-96 max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-gray-200 pt-3 space-y-2">
                  <p className="text-sm">
                    <span className="font-medium text-gray-700">Ota-ona telefoni:</span>{' '}
                  ...
                  <p className="text-sm">
                    ...
                    <span className="text-gray-600">
                      {(selectedStudent.birth_date || '').slice(0, 10) || 'Kiritilmagan'}
                    </span>
                  </p>
                  <p className="text-sm">
                  ...
                  <p className="text-sm">
                    ...
                    <span className="text-blue-600 text-sm">
                      {(selectedStudent.groups?.length || 0) > 0 ? 'Guruhda' : 'Guruhsiz'}
                    </span>
                  </p>
                  <p className="text-sm">
          ...
          <div className="divide-y divide-gray-100">
            {loading ? (
              ...
              filteredStudents.map((student, idx) => (
                <div
                  key={student._id || student.student_id || idx}
                  className={
                ...
                >
                  <div className="grid grid-cols-12 gap-4 items-center text-sm">
                    ...
                    <div className="col-span-2">
                      <span className="text-blue-600 text-sm">
                        {(student.groups?.length || 0) > 0 ? 'Guruhda' : 'Guruhsiz'}
                      </span>
                    </div>
