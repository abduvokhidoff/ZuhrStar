			...
			<div className='min-h-screen bg-gray-50 p-3 sm:p-6'>
				<div className='max-w-2xl mx-auto'>
					...
					<div className='grid gap-3 sm:gap-4'>
						{[1, 2, 3, 4, 5, 6].map(i => (
							<div key={i} className='bg-white rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6'>
						...
						<div>
							...
							{user2?.location && (
								<div className='flex items-center justify-center gap-1 text-gray-500'>
									...
									<span className='text-xs sm:text-sm truncate max-w-[150px]'>{user2.location}</span>
								</div>
							)}
						</div>
					</div>
						...
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-gray-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Email Address</h3>
									<p className='text-xs sm:text-sm text-gray-500'>Your primary email for communications</p>
								</div>
							</div>
					...
					<div className='bg-white rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200'>
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-gray-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Position Type</h3>
									<p className='text-xs sm:text-sm text-gray-500'>Your role and permissions level</p>
								</div>
							</div>
					...
					<div className='bg-white rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200'>
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-gray-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Phone Number</h3>
									<p className='text-xs sm:text-sm text-gray-500'>Your contact phone number</p>
								</div>
							</div>
							<div className='font-medium text-gray-900 text-sm sm:text-base ml-7 sm:ml-0'>
					...
					<div className='bg-white rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200'>
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-gray-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Birth Date</h3>
									<p className='text-xs sm:text-sm text-gray-500'>Your date of birth</p>
								</div>
							</div>
							<div className='font-medium text-gray-900 text-sm sm:text-base ml-7 sm:ml-0'>
					...
					<div className='bg-white rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200'>
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-gray-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Gender</h3>
									<p className='text-xs sm:text-sm text-gray-500'>Your gender identity</p>
								</div>
							</div>
							<div className='font-medium text-gray-900 text-sm sm:text-base ml-7 sm:ml-0'>
					...
					<div className='bg-red-50 rounded-xl sm:rounded-2xl shadow-md p-4 sm:p-6 mt-6 sm:mt-8'>
						<div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4'>
							<div className='flex items-center gap-3 sm:gap-4 min-w-0 flex-1'>
								...
								<div className='min-w-0 flex-1'>
									<h3 className='font-semibold text-red-900 mb-0.5 sm:mb-1 text-sm sm:text-base'>Delete Account</h3>
