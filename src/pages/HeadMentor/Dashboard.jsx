...
const Dashboard = () => {
		...
		<div className='bg-[#F5F4F6] min-h-screen p-3 sm:p-4 md:p-6'>
			{loading ? (
				...
				<>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6">
						{[...Array(4)].map((_, i) => (
							<div key={i} className="bg-white w-full p-4 sm:p-6 h-[120px] sm:h-[142px] rounded-lg shadow-sm">
						...
						{[...Array(4)].map((_, i) => (
							<div key={i} className='bg-white rounded-2xl p-6 shadow-sm'>
								...
								<div className='grid grid-cols-3 gap-4'>
									{[...Array(3)].map((_, j) => (
										<div key={j} className='h-24 bg-gray-200 rounded-xl animate-pulse'></div>
									))}
								</div>
							</div>
						))}
			...
			<div className='flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-6 sm:mb-8'>
				<div className='flex flex-col justify-center items-start'>
					<p className='text-sm sm:text-[16px] font-[400] text-[#7D8592]'>Xush Kelibsiz {user?.fullName}</p>
					<h1 className='text-2xl sm:text-3xl md:text-[36px] font-[700] text-[#0A1629]'>Boshqaruv paneli</h1>
				</div>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6">
				...
				<div className="bg-white w-full p-4 sm:p-6 h-[120px] sm:h-[142px] rounded-lg shadow-sm">
					<div className='flex justify-start items-center gap-2'>
						...
						<p className='text-xs sm:text-[14px] font-[500] text-[#858D9D]'>Mentorlar</p>
					</div>
				...
				<div className="bg-white w-full p-4 sm:p-6 h-[120px] sm:h-[142px] rounded-lg shadow-sm">
					<div className='flex justify-start items-center gap-2'>
						...
						<p className='text-xs sm:text-[14px] font-[500] text-[#858D9D]'>O&apos;quvchilar</p>
					</div>
					<div className='flex flex-col justify-start items-start pl-[14px] sm:pl-[20px] mt-4 sm:mt-6'>
				...
				<div className="bg-white w-full p-4 sm:p-6 h-[120px] sm:h-[142px] rounded-lg shadow-sm">
					<div className='flex justify-start items-center gap-2'>
						...
						<p className='text-xs sm:text-[14px] font-[500] text-[#858D9D]'>Guruhlar</p>
					</div>
					<div className='flex flex-col justify-start items-start pl-[14px] sm:pl-[20px] mt-4 sm:mt-6'>
				...
				<div className="bg-white w-full p-4 sm:p-6 h-[120px] sm:h-[142px] rounded-lg shadow-sm">
					<div className='flex justify-start items-center gap-2'>
						...
						<p className='text-xs sm:text-[14px] font-[500] text-[#858D9D]'>Davomat</p>
					</div>
					<div className='flex flex-col justify-start items-start pl-[14px] sm:pl-[20px] mt-4 sm:mt-6'>
						<p className='text-xl sm:text-2xl font-bold text-gray-900'>{positiveAttendance}%</p>
					</div>
				</div>
			</div>
   ...
   <div className='bg-white shadow-sm py-4 sm:py-[20px] rounded-lg flex flex-col gap-4 sm:gap-[30px] px-4 sm:px-[20px] overflow-visible mb-6'> 
    <div> 
     <h2 className='text-lg sm:text-[20px] font-[600] text-[#333843]'>Bugungi darslar</h2> 
    </div> 
						...
						>
							...
							<div className='flex items-center gap-3 mb-6 pb-6 border-b border-gray-100'>
								...
								<p className='text-sm text-gray-600'>
									Yaratilgan: <span className='font-semibold text-gray-800'>
							...
							<div className='grid grid-cols-3 gap-4'>
								...
								<div className='bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-xl text-center'>
									...
									<p className='text-xs text-gray-600 font-medium'>To'xtatilgan</p>
								</div>
							</div>
						</div>
					))}
