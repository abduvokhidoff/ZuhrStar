...
const Kurslar = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await authFetch(`${API_BASE_URL}/courses/id/${editForm._id}`, {
        method: 'PUT',
    ...
    if (window.confirm('Bu kursni o‘chirmoqchimisiz?')) {
      try {
        ...
        if (response.ok || response.status === 204) {
          ...
          const errorText = await response.text();
          console.error('Kursni o‘chirishda xatolik:', response.status, errorText);
                              ...
                              {editingId === kurs._id ? (
                                <div className="flex items-center space-x-1">
                                  ...
                                  <select
                                    ...
                                    onChange={(e) =>
                                      setEditForm({ ...editForm, duration_type: e.target.value })
                                    }
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              {editingId === kurs._id ? (
                                <input
                                  ...
                                  onChange={(e) =>
                                    setEditForm({ ...editForm, groups_count: e.target.value })
                                  }
                                  className="w-16 px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-blue-500"
                                />
                              ) : (
                              ...
                              <div className="flex space-x-2">
                                {editingId === kurs._id ? (
                                  ...
                                  <>
                                    ...
                                    <button onClick={() => handleDelete(kurs._id)}>
